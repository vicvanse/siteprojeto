    ...
    <main className="min-h-screen bg-[#f5f5f5] px-5 py-16 font-sans text-black sm:px-8 md:px-12">
      <article className="font-post mx-auto w-full max-w-[40rem]">
        <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-black/40">
          <Link
            href="/"
            className="text-[#791126] underline decoration-[#791126]/25 underline-offset-4 transition hover:decoration-[#791126]"
          >
            {tPost("backCrumb")}
          </Link>
        </p>
        ...
        >
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-3 flex flex-wrap items-baseline gap-x-3 gap-y-1">
              ...
              <span className="inline-flex rounded-full bg-[#791126]/10 px-2.5 py-0.5 text-[10px] font-medium tracking-[0.08em] text-[#791126]">
        ...
        <p className="mt-10 text-center">
          <Link
            href="/"
            className="text-[13px] font-medium text-[#791126] underline decoration-[#791126]/25 underline-offset-[5px] transition hover:decoration-[#791126]"
          >
            {tPost("back")}
          </Link>
        </p>
