...
export function SugestoesForm() {
  ...
  return (
    ...
    >
      ...
      {successBanner ? (
        <p
          className="rounded-lg border border-[#791126]/20 bg-[#791126]/5 px-4 py-3 text-[15px] leading-relaxed text-neutral-800"
          role="status"
        >
          {t("success")}
        </p>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          autoComplete="name"
          className="h-11 w-full rounded-lg border border-black/12 bg-white px-3 text-[15px] text-neutral-900 outline-none transition focus:border-[#791126]/45 focus:ring-2 focus:ring-[#791126]/15"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full resize-y rounded-lg border border-black/12 bg-white px-3 py-2.5 text-[15px] leading-relaxed text-neutral-900 outline-none transition focus:border-[#791126]/45 focus:ring-2 focus:ring-[#791126]/15"
        />
      </div>
                ...
                {imageFiles.map((f, i) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-md px-2 py-0.5 text-[12px] font-medium text-[#791126] underline-offset-2 hover:underline"
                    >
                      {t("remove")}
                    </button>
                  </li>
            ...
            {canAddMoreImages ? (
              <div className="space-y-2">
                <button
                  ...
                  className="inline-flex h-10 items-center rounded-lg border-0 bg-[#791126]/10 px-3 py-2 text-[13px] font-medium text-[#791126]"
                >
                  {t("chooseFiles")}
                </button>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="w-full space-y-4 rounded-lg border border-black/[0.06] bg-neutral-50/80 px-4 py-4 sm:max-w-[26rem] sm:px-5">
            <label className="flex cursor-pointer items-start gap-3 text-[15px] leading-snug text-neutral-900">
              <input
                ...
                className="mt-0.5 h-[1.15rem] w-[1.15rem] shrink-0 rounded border-black/25 accent-[#791126]"
              />
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="h-11 w-full rounded-lg border border-black/12 bg-white px-3 text-[15px] text-neutral-900 placeholder:text-black/35 outline-none transition focus:border-[#791126]/45 focus:ring-2 focus:ring-[#791126]/15"
              />
            </div>
          </div>
        ) : null}
        ...
        <button
          ...
          className="inline-flex h-11 min-w-[8rem] items-center justify-center rounded-xl border border-[#791126] bg-[#791126] px-6 text-[14px] font-medium text-white shadow-sm transition hover:bg-[#6a0f20] disabled:opacity-60 sm:rounded-full"
        >
