  ...
  if (post.feedCardHref) {
    return (
      <Link
        ...
        className={`group block rounded-lg no-underline outline-none transition-shadow duration-200 hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] focus-visible:ring-2 focus-visible:ring-[#404040]/35 focus-visible:ring-offset-2`}
      >
