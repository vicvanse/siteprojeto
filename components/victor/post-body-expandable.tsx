      ...
      {!open ? (
        <p className="mt-1">
          <button
            ...
            className="border-0 bg-transparent p-0 text-[15px] font-medium leading-[1.7] text-[#791126] underline decoration-[#791126]/30 underline-offset-[5px] transition hover:decoration-[#791126]"
            aria-expanded={false}
